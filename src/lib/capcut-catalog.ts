...
export const MOTION_CTA_CARDS: ShellCard[] = [
  ...
  },
  {
    ...
    label: "Comment",
    preview: "💬",
    hint: "Comment YES if this helped",
...
function transitionSwatch(id: TransitionKind): string {
  const map: Partial<Record<TransitionKind, string>> = {
    ...
    zoomout: "radial-gradient(circle,#0f172a,#2dd4a8)",
    slide: "linear-gradient(90deg,#0f172a,#2dd4a8)",
    slideright: "linear-gradient(270deg,#0f172a,#2dd4a8)",
    slideup: "linear-gradient(0deg,#0f172a,#2dd4a8)",
    slidedown: "linear-gradient(180deg,#0f172a,#2dd4a8)",
    push: "linear-gradient(90deg,#1e293b,#38bdf8)",
    whip: "linear-gradient(105deg,#0f172a 30%,#f472b6 50%,#0f172a 70%)",
    wipeleft: "linear-gradient(90deg,#2dd4a8 50%,#0f172a 50%)",
    wiperight: "linear-gradient(270deg,#2dd4a8 50%,#0f172a 50%)",
    wipeup: "linear-gradient(0deg,#2dd4a8 50%,#0f172a 50%)",
    wipedown: "linear-gradient(180deg,#2dd4a8 50%,#0f172a 50%)",
    iris: "radial-gradient(circle,#2dd4a8 35%,#0f172a 36%)",
